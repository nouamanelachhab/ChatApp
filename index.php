      ...
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <div aria-labelledby="userInfo" class="dropdown-menu"><a href="#" class="dropdown-item"><strong class="d-block text-uppercase headings-font-family">Mark Stephen</strong><small>Web Developer</small></a>
              ...
              <li class="sidebar-list-item"><a href="index.php" class="sidebar-link text-muted active"><i class="o-like-hand-1 mr-3 text-gray"></i><span>Matching</span></a></li>
              ...
              <li class="sidebar-list-item"><a href="profile.php" class="sidebar-link text-muted"><i class="o-user-details-1 mr-3 text-gray"></i><span>Friend request</span></a></li>
              <li class="sidebar-list-item"><a href="requests.php" class="sidebar-link text-muted"><i class="o-stack-1 mr-3 text-gray"></i><span>settings</span></a></li>
...
echo ' <form class="col-lg-5 mb-4 mb-lg-0 pl-lg-0" action="index.php" method="post">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="row align-items-center flex-row">
                      ...
                      <h6 class="mb-0">'.$varia[$i][1].'</h6>
                        ...
                        <hr><button type="submit" class="registerbtn" name="insert" value="'.$varia[$i][0].'">Add to Crush List</button>
